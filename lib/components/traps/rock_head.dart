...
class RockHead extends SpriteAnimationGroupComponent
  ...
  void _loadAllAnimations() {
    ...
    blinkAnimation = _spriteAnimation('Blink (42x42)', 4);
    topHitAnimation = _spriteAnimation('Top Hit (42x42)', 4);
    bottomHitAnimation = _spriteAnimation('Bottom Hit (42x42)', 4);
    leftHitAnimation = _spriteAnimation('Left Hit (42x42)', 4);
    rightHitAnimation = _spriteAnimation('Right Hit (42x42)', 4);
  }
